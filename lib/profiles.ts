...
export const GOLDEN_PROFILES: Record<BusinessSegment, BusinessProfile> = {
  trading: {
    ...
    capitalMult: 0.95, grossFAMult: 0.80, drawingsMult: 0.38,
  ...
  service: {
    ...
    capitalMult: 0.90, grossFAMult: 0.65, drawingsMult: 0.42,
  ...
  manufacturing: {
    ...
    revGrowth: 0.15, purGrowth: 0.12, expGrowth: 0.08,
    capitalMult: 1.05, grossFAMult: 1.20, drawingsMult: 0.35,
  ...
  construction: {
    ...
    revGrowth: 0.15, purGrowth: 0.12, expGrowth: 0.08,
    capitalMult: 1.00, grossFAMult: 1.00, drawingsMult: 0.36,
...
const PROFILE_CURVES: Record<BusinessSegment, DynamicProfileCurve> = {
  ...
  trading: {
    ...
    stockMonths:  [2.2, 1.6],          // realistic: small traders carry 2+ months stock
    debtorDays:   [38, 60],             // realistic: Indian MSME trading debtors 45-75 days
  ...
  service: {
    ...
    stockMonths:  [0.18, 0.65],
    debtorDays:   [32, 58],             // service firms: milestone billings take longer
    creditorDays: [10, 32],
    indExpRatio:  [0.80, 0.62],
    revGrowth:    [0.12, 0.24],
    capitalMult:  [0.65, 1.15],
  ...
  manufacturing: {
    ...
    stockMonths:  [2.4, 1.8],          // raw materials + WIP: 2-3 months typical
    debtorDays:   [42, 62],             // manufacturing: 45-75 day collection cycle
    creditorDays: [26, 56],
    indExpRatio:  [0.158, 0.108],
    revGrowth:    [0.11, 0.19],
    capitalMult:  [0.80, 1.30],
  ...
  construction: {
    ...
    stockMonths:  [1.6, 0.9],          // mixed stock: materials + mobilization
    debtorDays:   [40, 64],             // construction: retention + billing delays
    creditorDays: [25, 56],
    indExpRatio:  [0.205, 0.132],
    revGrowth:    [0.11, 0.19],
    capitalMult:  [0.75, 1.25],
